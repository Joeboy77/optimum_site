        ...
        <div class="row">
          <div class="col-md-12 mb-3">
              <div class="card-header d-sm-flex align-items-center justify-content-between">
                <span><i class="bi bi-table me-2"></i>Daily Transaction</span> 
                ...
                <div class="row">
                  <div class="col-12">
                    <table id="example" class="table table-striped table-hover text-center">
                      ...
                      <tbody id="data">
                        <?php
                          $query = "SELECT * FROM dailytransaction WHERE entrydate = '$_SESSION[date]'";
                        ...
                        <tr>
                          ...
                          <td><?php echo $row["tansaction_type"];?></td>
