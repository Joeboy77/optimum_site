...
<center>
  <span style="color: white; font-weight: bold;"><h6><?php echo $_SESSION['firstname'] ." ".$_SESSION['lastname']?></h6></span>
          ...
          <ul class="navbar-nav">
            ...
            <li>
              ...
              <div class="collapse" id="layouts21">
                <ul class="navbar-nav ps-3">
                  <li id="list">
                    <a href="addstudent.php" class="nav-link px-3">
                      <span>Add Student</span>
                    </a>
                  </li>
                  <li id="list">
                    <a href="studentinfo.php" class="nav-link px-3">
            ...
            <li id="list">
              <a href="feepayment.php" class="nav-link px-3">
                <span class="me-2"><i class="bi bi-calculator"></i></span>
                <span>Fee Payment</span>
              </a>
            </li>
            <li id="list">
              <a href="dailytransaction.php" class="nav-link px-3">
                <span class="me-2"><i class="bi bi-gem"></i></span>
                <span>Daily Transaction</span>
              </a>
            </li>
            <li id="list">
              <a href="visitor.php" class="nav-link px-3">
