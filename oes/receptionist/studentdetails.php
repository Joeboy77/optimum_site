                ...
                <div class="row">
                  <div class="col-md-12">
                    <div class="card">
                      <div class="card-body">
                        <div class="col-12">
                          <a href="studentinfo.php" class="btn btn-danger" type="submit">Back</a>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel">Update Debtors</h5>
        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
      </div>
      <form action="editcashindebt.php" method="POST" enctype="multipart/form-data">
      <div class="modal-body">
          ...
          <div class="mb-3">
            ...
            <textarea class="form-control" placeholder="Enter Location of Debtor" name="location"><?php echo $row['location'];?></textarea>
          </div>
        </div>
