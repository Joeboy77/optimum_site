        ...
        <div class="row">
          <div class="col-md-2 mb-1">
            <div class="card bg-primary text-white h-100">
              <div class="card-body py-3">Total Student</div>
          ...
          <div class="col-md-2 mb-1">
            <div class="card bg-primary text-white h-100">
              <div class="card-body py-3">Regular Student</div>
              <div class="card-footer d-flex">
                GhȻ 
                <!-- <span class="ms-auto">
                  <i class="bi bi-chevron-right"></i>
          ...
          <div class="col-md-2 mb-1">
            <div class="card bg-primary text-white h-100">
              <div class="card-body py-3">Weekend</div>
              <div class="card-footer d-flex">
                GhȻ 
                <!-- <span class="ms-auto">
                  <i class="bi bi-chevron-right"></i>
          ...
          <div class="col-md-2 mb-1">
            <div class="card bg-primary text-white h-100">
              <div class="card-body py-3">Online</div>
              <div class="card-footer d-flex">
                GhȻ 
                <!-- <span class="ms-auto">
                  <i class="bi bi-chevron-right"></i>
          ...
          <div class="col-md-2 mb-1">
            <div class="card bg-primary text-white h-100">
              <div class="card-body py-3">Residence</div>
              <div class="card-footer d-flex">
                GhȻ 
                <!-- <span class="ms-auto">
                  <i class="bi bi-chevron-right"></i>
          ...
          <div class="col-md-2 mb-1">
            <div class="card bg-primary text-white h-100">
              <div class="card-body py-3">Non Residence</div>
              <div class="card-footer d-flex">
                GhȻ 
                <!-- <span class="ms-auto">
                  <i class="bi bi-chevron-right"></i>
        ...
        <div class="row">
          <div class="col-md-12 mb-3">
              <div class="card-header d-sm-flex align-items-center justify-content-between">
                <span><i class="bi bi-table me-2"></i>Student Info</span> 
                ...
                <div class="row">
                  <div class="col-12">
                    <table id="example" class="table table-striped table-hover text-center">
                      ...
                      <tbody id="data">
                        <?php
                          $query = "SELECT * FROM student_registration WHERE active != ''";
                        ...
                        <tr>
                          ...
                          <td>
                            <a href="studentdetails.php?id=<?php echo $row["id"];?>" class="btn btn-primary"><i class="bi bi-eye"></i></a>
                          </td>
                        </tr>
                        <?php
                        $no++;
