       ...
       if (isset($_SESSION["status"]) && $_SESSION["status"] != '') {
        ...
        <div class="col-md-6 offset-md-3">
            <div class="signup-form">
                <form action="code.php" method="POST" class="border p-4 bg-lightgrey shadow" onsubmit="return true;">
                    <div>
                        <center>
