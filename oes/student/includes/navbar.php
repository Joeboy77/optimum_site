          ...
          <ul class="navbar-nav">
            ...
            <li>
              ...
              <div class="collapse" id="layouts21">
                <ul class="navbar-nav ps-3">
                  <li id="list">
                    <a href="courseupload.php" class="nav-link px-3">
                      <span>Tution Upload</span>
                    </a>
                  </li>
                  <li id="list">
                    <a href="availablequizzes.php" class="nav-link px-3">
                      <span>Take a Test</span>
                    </a>
                  </li>
                  <li id="list">
                    <a href="fee.php" class="nav-link px-3">
            ...
            <li>
              ...
              <div class="collapse" id="layouts2">
                <ul class="navbar-nav ps-3">
                  <li id="list">
                    <a href="availableexams.php" class="nav-link px-3">
                      <span>Available Exams</span>
                    </a>
                  </li>
                  <li id="list">
                    <a href="myresults.php" class="nav-link px-3">
