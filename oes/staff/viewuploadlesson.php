        ...
        <div class="row">
          <div class="col-md-12 mb-3">
              <div class="card-header d-sm-flex align-items-center justify-content-between">
                <span><i class="bi bi-table me-2"></i> Uploaded Lesson</span> 
                <!-- <div class="text-xs font-weight-bold">No. of Rooms: ... </div> -->
                <button type="button" class="btn btn-sm btn-success" data-bs-toggle="modal" data-bs-target="#exampleModal"><i class="bi bi-plus"></i> Edit Lesson</button>
              </div>
              <div>
                <?php
                    ...
                    <div class="card shadow h-100 py-2">
                      ...
                      <div class="card-body">
                        <div>
                          ...
                          <div class="row mb-2">
                            <iframe src="<?php echo $row["lesson_file"];?>" style="width: 100%; height: min(400px, 1000px);"></iframe>
                ...
                <div class="row">
                  <div class="col-md-12">
                    <div class="card">
                      <div class="card-body">
                        <div class="col-12">
                          <a href="uploadlesson.php" class="btn btn-danger" type="submit">Back</a>
