    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-light fixed-top static-top shadow">
      ...
      <div class="container-fluid">
        ...
        <a
          ...
          href="index.php"
          >
          <span>Optimum</span> <span class="text-primary">TI</span>
          ...
          <ul class="navbar-nav">
            ...
            <li>
              <a
                ...
                id="list"
              >
                <span class="me-2"><i class="bi bi-hdd-rack"></i></span>
              ...
              <div class="collapse" id="layouts21">
                <ul class="navbar-nav ps-3">
                  ...
                  <li id="list">
                    <a href="createclass.php" class="nav-link px-3">
                      <span>Create Class</span>
                    </a>
                  </li>
                  <li id="list">
                    <a href="uploadlesson.php" class="nav-link px-3">
                      <span>Upload Lesson Note</span>
                    </a>
                  </li>
                  <li id="list">
                    <a href="myquizzes.php" class="nav-link px-3">
                      <span>My Quizzes</span>
                    </a>
                  </li>
                  <li id="list">
                    <a href="createquiz.php" class="nav-link px-3">
            ...
            <li id="list">
              <a href="complain.php" class="nav-link px-3">
            ...
            <li>
              ...
              <div class="collapse" id="layouts2">
                <ul class="navbar-nav ps-3">
                  <li id="list">
                    <a href="myexams.php" class="nav-link px-3">
                      <span>My Exams</span>
                    </a>
                  </li>
                  <li id="list">
                    <a href="createexam.php" class="nav-link px-3">
                      <span>Create Exam</span>
                    </a>
                  </li>
                  <li id="list">
                    <a href="myquestions.php" class="nav-link px-3">
