        ...
        <div class="row">
          <div class="col-md-12 mb-3">
              <div class="card-header d-sm-flex align-items-center justify-content-between">
                <span><i class="bi bi-table me-2"></i>New Student</span> 
                <div class="text-xs font-weight-bold">
                  <a href="addstudent.php" class="btn btn-primary btn-sm"><i class="bi bi-plus"></i> Add Student</a>
                  <a href="approvedstudent.php" class="btn btn-success btn-sm"><i class="bi bi-eye"></i> View Registered Student</a>
                </div>
              </div>
              <div class="card-body">
                <div class="row">
                  <div class="col-12">
                     <table id="example" class="table table-striped table-hover text-center">
                      ...
                      <tbody id="data">
                        <?php
                          // Pending approvals: students with empty fees (if column exists) and not blocked
                          ...
                          if ($hasFees) { $where[] = "(fees = '' OR fees IS NULL)"; }
                        ...
                        <tr>
                          ...
                          <td>
                            <a href="studentdetails.php?id=<?php echo $row["id"];?>" class="btn btn-success btn-sm"><i class="bi bi-eye"></i></a>
                          </td>
                          <td>
                            ...
                            <?php if ($hasActive && ($row['active']==='Blocked')) { ?>
                              <form action="student.php" method="POST" class="d-inline">
...
if (isset($_POST['update_student'])) {
  ...
  if ($fname === '' || $lname === '') { $_SESSION['status'] = 'Firstname and Lastname are required'; echo '<script type="text/javascript">window.location="student.php"</script>'; exit(); }
  ...
  echo '<script type="text/javascript">window.location="student.php"</script>'; exit();
}
...
if (isset($_POST['block_student'])) {
  $sid = mysqli_real_escape_string($con, $_POST['student_id']);
  // Only set active if column exists
  ...
  $_SESSION['success'] = 'Student blocked'; echo '<script type="text/javascript">window.location="student.php"</script>'; exit();
}
if (isset($_POST['unblock_student'])) {
  ...
  $_SESSION['success'] = 'Student unblocked'; echo '<script type="text/javascript">window.location="student.php"</script>'; exit();
}
?>