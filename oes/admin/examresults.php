    ...
    <div class="row">
      <div class="col-md-12 mb-3">
        <div class="card-header d-sm-flex align-items-center justify-content-between">
          <span><i class="bi bi-table me-2"></i>Exam Results</span> 
        </div>
        <?php
          ...
          <div class="row align-items-center justify-content-center">
            <div class="col-md-12">
              <table id="example" class="table table-striped table-hover text-center">
                ...
                <tbody id="data">
                  <?php
                  $query = "SELECT r.*, e.title as exam_title, e.course, e.total_questions, e.totalmarks, s.firstname, s.lastname, s.indexnumber 
                           FROM exam_results r 
                  ...
                  // No results yet; render no rows so DataTables can handle empty state
                }
                ?>
                </tbody>
              </table>
