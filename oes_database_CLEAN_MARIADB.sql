...
INSERT INTO `courses` (programType, course_name, programTypeID, course_code) VALUES ('Computer Science', 'System Design', 1, 'C001'), ('Computer Science', 'Programming', 1, 'C002');
...
INSERT INTO `programtype` (`program`, `cost`) VALUES ('Computer Science', '0.00'), ('Information Technology', '0.00');
...
INSERT INTO `registration` (indexnumber, firstname, lastname, email, username, password, status, position) VALUES ('ADMIN001', 'Admin', 'User', 'admin@example.com', 'admin', 'admin123', 'Staff', 'Admin');
